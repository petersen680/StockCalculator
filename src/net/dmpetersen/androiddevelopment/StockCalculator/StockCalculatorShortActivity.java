...
public class StockCalculatorShortActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mainshort);
 ...
 */
    	    ...
    	    if(price2.doubleValue() == 0 || limitTarget2.doubleValue() == 0 
    	    	...
    	    	Intent i = new Intent("net.dmpetersen.androiddevelopment.StockCalculator.SCERRORACTIVITY");            
    	    ...
    	    else if(stopAmount2.doubleValue() < ((stopTarget2.doubleValue() - price2.doubleValue()) + (2 * commission2.doubleValue()))){
    	    	...
    	    	message = getString(R.string.message7);
    ...
    private void calculate(){
       ...
       double r_T_Commission = commission2.doubleValue() + commission2.doubleValue();
       	     ...
       	     while(temp3 < stopAmount2.doubleValue() - r_T_Commission){
       	    	 ...
       	    	 //reversed these
       	        temp2 = price2.doubleValue() * numberOfShares;  
       	        total = stopTarget2.doubleValue() * numberOfShares;
       	        
       	        //reversed here
       	        atRisk = temp3 + (stopTarget2.doubleValue() - price2.doubleValue() ) + r_T_Commission;
       	        temp3 = total - temp2;   
       	     ...
       	     Double profitIf = new Double(((price2.doubleValue() * numberOfShares) - r_T_Commission) - (limit.doubleValue() * numberOfShares));
